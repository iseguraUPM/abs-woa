...
class GraphGameMap implements PathfinderGameMap {
     ...
     * at 1,1. The first coordinate raises DOWN of the origin. The second
     * coordinate raises RIGHT of the origin. Both coordinates are always ODD or
     * both EVEN. The maximum possible coordinate is [height,width]. The cells
     * are wrapped around in a way that the [1,1] cell is always adjacent to the
     * [height,width] cell and other 5 cells.
     *
